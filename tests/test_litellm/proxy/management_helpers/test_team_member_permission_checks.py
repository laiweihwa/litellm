...
class TestEnforceMemberCanAssignAccessGroups:
    ...
    def test_personal_key_non_admin_denied_veria_218(self):
        """VERIA-218: a non-admin cannot self-grant access_group_ids on a
        personal (no team) key — the access_group_id grants model access at
        use-time without any team-membership cross-check."""
    ...
    def test_personal_key_proxy_admin_can_assign_veria_218(self):
        """Proxy admins keep the LIT-3815 carve-out: they may assign access
