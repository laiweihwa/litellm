...
class TeamMemberPermissionChecks:
    ...
    def enforce_member_can_assign_access_groups(
        ...
        # Personal (non-team) keys: non-admin callers cannot self-grant access
        # groups, since access_group_ids are stored on the key and grant model
        # access at use-time without a team-membership check (VERIA-218).
